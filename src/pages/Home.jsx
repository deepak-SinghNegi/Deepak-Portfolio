  ...
  return (
    <div>
      ...
      <div className='text-center'>
        <div>
          <strong
            className='font-bold md:text-8xl text-5xl bg-gradient-to-r
                       from-purple-400
                       via-pink-500
                       to-red-500
                       bg-clip-text
        ...
        <div className='md:text-xl text-xs mt-6 text-white/70'>
          Focused on mastering Data Structures,
          <br />
          System Design, and building scalable backend applications.
        </div>
      ...
      <div className="mt-20 max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <a
            href="https://www.linkedin.com/in/deepak-singh-negi-633971371/"
            target="_blank"
          ...
          <a
            href="https://github.com/deepak-SinghNegi"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="https://leetcode.com/u/deepaknegi16360/"
            target="_blank"
            rel="noopener noreferrer"
